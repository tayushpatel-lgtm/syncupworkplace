    ...
    inputSchema: {
      ...
      properties: {
        ...
        repeat: {
          ...
          enum: TASK_REPEATS,
          description:
            'How often it comes back after it is completed. NONE is a one-off. WEEKDAYS is Monday to Saturday. Completing a repeating task creates the next occurrence.',
        },
...
export async function runTool(name, args = {}, ctx = {}) {
  switch (name) {
    ...
    case 'assign_task': {
      ...
      const recurrence = parseRepeatInput(args, { todayKey: dayKey() });
      if (
